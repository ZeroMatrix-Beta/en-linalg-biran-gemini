...
\begin{proof}
Statements \textbf{(a)} and \textbf{(b)} follow trivially from the vector space axioms (specifically the commutativity of vector addition and the property that $0 \cdot v = 0_V$).
