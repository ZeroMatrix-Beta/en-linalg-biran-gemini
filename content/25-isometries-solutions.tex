% Solution: Gemini / Official Hybrid (Problem Sheet 26, Exercise 2)
...
\end{enumerate}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 26, Exercise 2). Verifies special orthogonality and computes rotation axis and angle from trace for a $3 \times 3$ matrix.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 26, Exercise 5)
...
\end{itemize}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 26, Exercise 5). Proves $|\Tr(f)| \le n$ for orthogonal endomorphisms via complex eigenvalues and characterizes the equality cases.}
\end{exercisesolution}

% Official Solution (Problem Sheet 26, Exercise 6)
...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    \]
\end{enumerate}
\exinfo{Official Solution (Problem Sheet 26, Exercise 6). Classifies rotations in $\SOrth(3)$ mapping a 2D subspace to itself and between two given 2D planes.}
\end{exercisesolution}
