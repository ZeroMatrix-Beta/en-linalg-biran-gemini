% Solution: Gemini / Official Hybrid (Problem Sheet 24, SO(3) Axis and Angle)
...
\end{enumerate}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Biran Lecture Notes). Verifies special orthogonality and computes rotation axis and angle from trace for a $3 \times 3$ matrix.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 24, Trace Bound of Orthogonal Endomorphisms)
...
\end{itemize}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Biran Lecture Notes). Proves $|\Tr(f)| \le n$ for orthogonal endomorphisms via complex eigenvalues and characterizes the equality cases.}
\end{exercisesolution}

% Official Solution (Problem Sheet 24, Exercise 3)
...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    \]
\end{enumerate}
\exinfo{Official Solution (Problem Sheet 24, Exercise 3). Classifies rotations in $\SOrth(3)$ mapping a 2D subspace to itself and between two given 2D planes.}
\end{exercisesolution}
