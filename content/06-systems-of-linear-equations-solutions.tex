...
% Solution: Gemini / Official Hybrid (Problem Sheet 4, Exercise 4)
...
\end{remark}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 4, Exercise 4). Examines row equivalence vs solution set equality for inconsistent and non-square systems.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 3, Exercise 1)
...
3 & 6 & 2 & 5 & \big| & 1
\end{pmatrix}
\xrightarrow{R_2 - 3 \cdot R_1 \to R_2}
\begin{pmatrix}
1 & 2 & 2 & 1 & \big| & -1 \\
0 & 0 & -4 & 2 & \big| & 4
\end{pmatrix}
...
\end{pmatrix}
\]
Now clear the entry above the second pivot by $R_1 - 2 \cdot R_2 \to R_1$:
\[
...
\]
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 3, Exercise 1). Fully works out Gaussian elimination into reduced row echelon form with 2 free variables.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 4, Exercise 3)
...
2 & 3 & -4 & \big| & 3 & 3
\end{pmatrix}
\xrightarrow{\begin{subarray}{l} R_2 - R_1 \to R_2 \\ R_3 - 2 \cdot R_1 \to R_3 \end{subarray}}
\begin{pmatrix}
1 & 1 & 1 & \big| & 6 & 7 \\
0 & 1 & 1 & \big| & 5 & 3 \\
0 & 1 & -6 & \big| & -9 & -11
...
0 & 0 & -7 & \big| & -14 & -14
\end{pmatrix}
\xrightarrow{-\frac{1}{7} \cdot R_3 \to R_3}
\begin{pmatrix}
1 & 1 & 1 & \big| & 6 & 7 \\
0 & 1 & 1 & \big| & 5 & 3 \\
0 & 0 & 1 & \big| & 2 & 2
...
\[
\xrightarrow{\begin{subarray}{l} R_2 - R_3 \to R_2 \\ R_1 - R_3 \to R_1 \end{subarray}}
\begin{pmatrix}
1 & 1 & 0 & \big| & 4 & 5 \\
0 & 1 & 0 & \big| & 3 & 1 \\
0 & 0 & 1 & \big| & 2 & 2
...
\end{itemize}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 4, Exercise 3). Applies simultaneous Gaussian elimination on a dual augmented matrix.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 4, Exercise 2)
...
2 & 4 & -3 & \big| & 5
\end{pmatrix}
\xrightarrow{\begin{subarray}{l} R_2 - 3 \cdot R_1 \to R_2 \\R_3 + 3 \cdot R_1 \to R_3 \\ R_4 - 2 \cdot R_1 \to R_4 \end{subarray}}
\begin{pmatrix}
1 & 2 & -3 & \big| & 10 \\
0 & 1 & 0 & \big| & b - 30 \\
0 & 1 & a - 9 & \big| & b + 30 \\
...
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 4, Exercise 2). Analyzes consistency parameters $a, b$ and determines the unique solution.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 3, Exercise 4)
...
\[
\xrightarrow{R_3 - 4 \cdot R_1 \to R_3}
\begin{pmatrix}
1 & -2 & \frac{1}{2} & \big| & -b_2 \\
0 & 7 & -2 & \big| & b_1 \\
0 & 7 & -2 & \big| & b_3 + 4b_2
...
\]
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 3, Exercise 4). Computes the solvability hyperplane condition $b_1 - 4b_2 - b_3 = 0$ via row reduction.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 4, Exercise 5)
...
\begin{itemize}
    \item If $a \ne 0$, apply $R_2 - \frac{c}{a} \cdot R_1 \to R_2$ to obtain the second row $\bigl(0, \; d - \frac{bc}{a} \;\big|\; b_2 - \frac{c}{a}b_1\bigr)$. Since the rows are not proportional, $ad - bc \ne 0$, so the pivot $d - \frac{bc}{a} \ne 0$, which allows solving for both unknowns uniquely for any $(b_1, b_2)$.
...
\end{ainote}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 4, Exercise 5). Proves the contrapositive geometric condition for $2 \times 2$ inconsistent systems using both determinant invertibility and echelon reduction.}
\end{exercisesolution}
