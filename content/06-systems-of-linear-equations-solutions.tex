...
% Solution: Gemini / Official Hybrid (Problem Sheet 4, Exercise 6)
...
\end{remark}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 4, Exercise 6). Examines row equivalence vs solution set equality for inconsistent and non-square systems.}
...
\]
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 4, Exercise 2). Fully works out Gaussian elimination into reduced row echelon form with 2 free variables.}
\end{exercisesolution}
...
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 4, Exercise 4). Analyzes consistency parameters $a, b$ and determines the unique solution.}
\end{exercisesolution}
...
\]
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 4, Exercise 5). Computes the solvability hyperplane condition $b_1 - 4b_2 - b_3 = 0$ via row reduction.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 4, Exercise 1)
