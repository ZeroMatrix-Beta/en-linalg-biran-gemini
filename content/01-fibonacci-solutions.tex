% Solution: Gemini / Official Hybrid (Problem Sheet 1, Exercise 6)
...
\end{ainote}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 1, Exercise 6). Method 1 presents the geometric eigenbasis and determinant argument; the alternative recurrence shift in the note above follows the ETH sample solution (suggested by Segev).}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 1, Exercise 1)
...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    \]
\end{enumerate}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 1, Exercise 1). Solves for the basis sequence $\mathcal{F}_{1,0}$ and general $\mathcal{F}_{a,b}$ using the standard geometric eigenbasis decomposition.}
\end{exercisesolution}

% Official Solution (Problem Sheet 1, Exercise 3)
...
\]
\exinfo{Official Solution (Problem Sheet 1, Exercise 3). Computes the algebraic limit of consecutive Fibonacci ratios via the characteristic polynomial.}
\end{exercisesolution}
