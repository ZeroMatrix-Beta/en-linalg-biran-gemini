...
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 1, Exercise 6). Method 1 presents the geometric eigenbasis and determinant argument; the alternative recurrence shift in the note below follows the ETH sample solution (suggested by Segev).}
