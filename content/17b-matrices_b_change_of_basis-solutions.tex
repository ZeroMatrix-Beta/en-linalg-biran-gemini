...
\exinfo{Official Solution (Problem Sheet 11, Exercise 5). Proves similarity of $AB$ and $BA$ when at least one matrix is invertible and constructs a nilpotency counterexample otherwise.}
...
\exinfo{Official Solution (Problem Sheet 11, Exercise 6). Shows similarity preserves shifted rank $\rank(A - I_n)$ and connects nullity to fixed vectors.}
...
\exinfo{Official Solution (Problem Sheet 11, Exercise 7). Computes the change of basis transition matrix between quadratic polynomial bases.}
...
\exinfo{Official Solution (Problem Sheet 11, Exercise 8). Evaluates statements on rank upper bounds, change-of-basis definitions, and matrix invertibility.}
