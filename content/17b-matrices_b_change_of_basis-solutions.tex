...
\end{enumerate}
\exinfo{Official Solution (Problem Sheet 13, Exercise 5). Proves similarity of $AB$ and $BA$ when at least one matrix is invertible and constructs a nilpotency counterexample otherwise.}
\end{exercisesolution}

% Official Solution (Problem Sheet 13, Exercise 6)
...
\exinfo{Official Solution (Problem Sheet 13, Exercise 6). Shows similarity preserves shifted rank $\rank(A - I_n)$ and connects nullity to fixed vectors.}
\end{exercisesolution}

% Official Solution (Problem Sheet 13, Exercise 7)
...
\]
\exinfo{Official Solution (Problem Sheet 13, Exercise 7). Computes the change of basis transition matrix between quadratic polynomial bases.}
\end{exercisesolution}

% Official Solution (Problem Sheet 13, Exercise 8)
...
\end{itemize}
\exinfo{Official Solution (Problem Sheet 13, Exercise 8). Evaluates statements on rank upper bounds, change-of-basis definitions, and matrix invertibility.}
\end{exercisesolution}
