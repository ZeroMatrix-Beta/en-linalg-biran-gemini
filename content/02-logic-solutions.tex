...
\exinfo{Official source: Problem Sheet 1, Exercise 5. Derives the contrapositive via predicate negation rules.}
...
\exinfo{Official source: Problem Sheet 2, Exercise 1. Formulates the non-existence of a maximum in $\mathbb{N}$ and demonstrates logical equivalence.}
...
\exinfo{Official source: Problem Sheet 1, Exercise 4. Step-by-step predicate distribution applying De Morgan's laws.}
