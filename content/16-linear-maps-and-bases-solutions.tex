...
\exinfo{Official Solution (Problem Sheet 10, Exercise 1). Evaluates statements on coordinate isomorphisms, nullspace-image intersections, and injectivity vs.~bijectivity.}
...
\exinfo{Official Solution (Problem Sheet 10, Exercise 2). Connects coordinate representation matrices to rotations, reflections, and basis changes in $\mathbb{R}^2$.}
...
\exinfo{Official Solution (Problem Sheet 10, Exercise 3). Identifies multiplication by $i$ on $\mathbb{C} \cong \mathbb{R}^2$ from its representation matrix in the basis $(1, i)$.}
...
\exinfo{Official Solution (Problem Sheet 10, Exercise 4). Computes the upper triangular representation matrix of $p \mapsto p'' + p'$ on $\mathbb{R}[X]_n$ in the monomial basis.}
...
\exinfo{Official Solution (Problem Sheet 10, Exercise 5). Constructs customized polynomial bases of $\mathbb{R}[x]_3$ and $\mathbb{R}[x]_2$ realizing a target upper triangular matrix for differentiation.}
...
\exinfo{Official Solution (Problem Sheet 10, Exercise 6). Verifies basis conditions via determinants, computes composite representations, and confirms the matrix product formula $[g \circ f]_{\mathcal{C}}^{\mathcal{A}} = [g]_{\mathcal{C}}^{\mathcal{B}} [f]_{\mathcal{B}}^{\mathcal{A}}$.}
\begin{enumerate}[label=\textbf{(\alph*)}]
