...
% Official Solution (Problem Sheet 11, Multiple Choice Question 2)
...
\end{enumerate}
Thus, statements \textbf{(a)} and \textbf{(c)} are true, while statement \textbf{(b)} is false.
\exinfo{Official Solution (Problem Sheet 11, Multiple Choice Question 2). Evaluates statements on coordinate isomorphisms, nullspace-image intersections, and injectivity vs.~bijectivity.}
\end{exercisesolution}

% Official Solution (Problem Sheet 11, Multiple Choice Question 1)
...
\exinfo{Official Solution (Problem Sheet 11, Multiple Choice Question 1). Connects coordinate representation matrices to rotations, reflections, and basis changes in $\mathbb{R}^2$.}
\end{exercisesolution}

% Official Solution (Problem Sheet 13, Single Choice Question 2)
...
\]
Therefore, the correct choice is \textbf{(d): $z \mapsto iz$}.
\exinfo{Official Solution (Problem Sheet 13, Single Choice Question 2). Identifies multiplication by $i$ on $\mathbb{C} \cong \mathbb{R}^2$ from its representation matrix in the basis $(1, i)$.}
\end{exercisesolution}
...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    \]
\end{enumerate}
\exinfo{Official Solution (Problem Sheet 11, Exercise 2). Computes the upper triangular representation matrix of $p \mapsto p'' + p'$ on $\mathbb{R}[X]_n$ in the monomial basis.}
\end{exercisesolution}
...
\]
\exinfo{Official Solution (Problem Sheet 11, Exercise 7). Constructs customized polynomial bases of $\mathbb{R}[x]_3$ and $\mathbb{R}[x]_2$ realizing a target upper triangular matrix for differentiation.}
\end{exercisesolution}
...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    \begin{itemize}
        ...
        &= \det \begin{pmatrix} 1 & 1 & 1 & 2 \\ 0 & 2 & 0 & 0 \\ 1 & 2 & 1 & 3 \\ 0 & 2 & 1 & 0 \end{pmatrix} \quad (R_2 - R_4 \to R_2) \\
    ...
    \end{enumerate}
\end{enumerate}
\exinfo{Official Solution (Problem Sheet 11, Exercise 5). Verifies basis conditions via determinants, computes composite representations, and confirms the matrix product formula $[g \circ f]_{\mathcal{C}}^{\mathcal{A}} = [g]_{\mathcal{C}}^{\mathcal{B}} [f]_{\mathcal{B}}^{\mathcal{A}}$.}
\end{exercisesolution}
