...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    By the Spectral Theorem (\cref{thm:spectral_thm_c}), $V = W_1 \oplus \dots \oplus W_k$, where $W_j := \Eig_T(\lambda_j)$ are the distinct eigenspaces of $T$ corresponding to distinct eigenvalues $\lambda_1, \dots, \lambda_k \in \mathbb{C}$.
