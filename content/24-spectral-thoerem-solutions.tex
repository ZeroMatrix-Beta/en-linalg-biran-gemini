% Solution: Gemini / Official Hybrid (Problem Sheet 23, Symmetric Matrix Eigenvectors)
...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    \[
    \operatorname{rank}(A\transp A) = n - \dim\ker(A\transp A) = n - \dim\ker(A) = \operatorname{rank}(A).
    \]
...
\end{enumerate}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Biran Lecture Notes). Establishes positive definiteness of $A\transp A$, rank equality, and orthogonality of distinct eigenspaces for symmetric matrices.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 23, Spectral Decomposition)
...
\end{enumerate}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Biran Lecture Notes). Derives the spectral decomposition of normal operators into orthogonal projections and verifies self-adjointness of projections.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 23, Non-Orthonormal Bases)
...
\end{enumerate}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Biran Lecture Notes). Clarifies that matrix symmetry implies self-adjointness only when computed in an orthonormal basis.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 23, Fourier Differential Operators)
...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    \end{itemize}
\end{enumerate}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Biran Lecture Notes). Computes adjoints and eigenbasis of derivative and 1D Laplacian on periodic smooth functions.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 23, Algebraic Operations on Normal Matrices)
...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    \end{enumerate}
\end{enumerate}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Biran Lecture Notes). Characterizes algebraic operations, commutator relations, and polynomial evaluations on normal matrices.}
\end{exercisesolution}
