...
\exinfo{Official Solution (Problem Sheet 4, Exercise 3). Checks failure of vector space axioms for extended real numbers.}
...
\exinfo{Official Solution (Problem Sheet 4, Multiple Choice). Identifies the power-operation scalar multiplication on $\mathbb{R}_{>0}^2$.}
...
\exinfo{Official Solution (Problem Sheet 4, Exercise 4). Verifies subspaces over $\mathbb{R}$ versus $\mathbb{F}_2$.}
\begin{enumerate}[label=\textbf{(\alph*)}]
...
\exinfo{Official Solution (Problem Sheet 4, Single Choice). Tests closure axioms for candidate subsets in $\mathbb{R}^n$.}
\begin{enumerate}[label=\textbf{(\arabic*)}]
...
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 4, Exercise 5). Compares union of three subspaces over $\mathbb{F}_2$ with $\mathbb{R}$.}
...
\exinfo{Solution by Gemini 3.7 Flash (High). Analyzes the affine solution geometry under parameter variations.}
\begin{enumerate}[label=\textbf{(\alph*)}]
...
\exinfo{Official Solution (Problem Sheet 4, Exercise 6). Proves direct sum decomposition into even and odd function subspaces for $\operatorname{char}(K) \ne 2$.}
