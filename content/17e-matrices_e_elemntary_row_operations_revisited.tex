...
Write $(C \mid D) \in \M_{n \times 2n}(K)$ for the matrix whose first $n$ columns are those of $C$ and whose last $n$ columns are those of $D$. By the column-wise description of a product, multiplying on the left by $B$ acts on each column separately:
\[
