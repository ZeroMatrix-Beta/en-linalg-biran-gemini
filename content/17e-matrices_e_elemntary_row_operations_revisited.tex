...
\]
\end{theorem*}
\exhint{Choose an invertible upper triangular matrix $U$ such that the sum of the number of leading zeros in all rows of $UA$ is maximal. Then find a permutation matrix $Q$ such that $QUA$ is an invertible upper triangular matrix.}
