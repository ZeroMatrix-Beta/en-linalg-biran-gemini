...
\exinfo{Official Solution (Problem Sheet 12, Exercise 2). Demonstrates rank invariance under multiplication by an invertible matrix.}
...
\exinfo{Official Solution (Problem Sheet 12, Exercise 3). Computes the rank of a $2 \times 2$ matrix with linearly dependent rows.}
...
\exinfo{Official Solution (Problem Sheet 12, Exercise 4). Unifies 5 equivalent characterizations of invertibility for square representation matrices via row and column rank.}
...
\exinfo{Official Solution (Problem Sheet 12, Exercise 5). Determines the explicit rank of three $n \times n$ rational matrix families: outer products, arithmetic progressions, and Pascal matrices.}
