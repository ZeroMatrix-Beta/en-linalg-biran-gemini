% Official Solution (Problem Sheet 23, Exercise 4)
...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    \]
\end{enumerate}
\exinfo{Official Solution (Problem Sheet 23, Exercise 4). Computes orthonormal bases and representation matrices for orthogonal projections onto $U$ and $U^\perp$.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 24, Exercise 3)
...
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 24, Exercise 3). Proves the Best Approximation Theorem in inner product spaces via Pythagoras.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 24, Exercise 4)
...
\end{align*}
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 24, Exercise 4). Computes degree 5 polynomial least-squares approximation of $\sin(x)$ on $[-\pi, \pi]$ via normal equations.}
\end{exercisesolution}

% Official Solution (Problem Sheet 23, Exercise 5)
...
\end{enumerate}
\exinfo{Official Solution (Problem Sheet 23, Exercise 5). Constructs dense subspaces with trivial orthogonal complements in $\ell^2$ and $C[0,1]$.}
\end{exercisesolution}
...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    \item \begin{itemize}
        ...
        \item $A_3 = \frac{1}{\sqrt{5}}\begin{pmatrix} i & -2 \\ 2 & -i \end{pmatrix}$: $A_3^* = \frac{1}{\sqrt{5}}\begin{pmatrix} -i & 2 \\ -2 & i \end{pmatrix} \ne A_3$ (not Hermitian, skew-Hermitian), and $A_3^* A_3 = \frac{1}{5}\begin{pmatrix} 1+4 & 2i - 2i \\ -2i + 2i & 4+1 \end{pmatrix} = I_2$ (unitary).
...
% Official Solution (Problem Sheet 23, Exercise 3)
...
\end{enumerate}
\exinfo{Official Solution (Problem Sheet 23, Exercise 3). Computes QR decomposition via Gram-Schmidt and solves linear system via back-substitution.}
\end{exercisesolution}
