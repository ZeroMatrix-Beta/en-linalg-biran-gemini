% Official Solution (Problem Sheet 8, Exercise 3)
...
\exinfo{Official Solution (Problem Sheet 8, Exercise 3). Proves that any linearly independent subset of a countably-generated vector space is at most countable.}
