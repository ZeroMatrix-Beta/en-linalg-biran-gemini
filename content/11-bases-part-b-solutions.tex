% Official Solution (Problem Sheet 7, Exercise 5)
...
\exinfo{Official Solution (Problem Sheet 7, Exercise 5). Proves that any linearly independent subset of a countably-generated vector space is at most countable.}
