...
To prove this rigorouslyâ€”especially since $S$ might be an infinite set, like the set of all polynomialsâ€”we must first formalize what we mean by "a unique way as a linear combination." In a vector space, we can only ever add a \textit{finite} number of vectors together. 
