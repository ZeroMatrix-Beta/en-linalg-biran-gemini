...
Then, by applying \textbf{(V2)} to both, we get: $0_1 = 0_1 + 0_2 = 0_2 + 0_1 = 0_2$. Thus, $0_1 = 0_2$.
...
Thus, the inverse is unique.
    ...
    \item Consider $0 \cdot v = (0 + 0) \cdot v = 0 \cdot v + 0 \cdot v$, where the second equality is \textbf{(V8)}.
