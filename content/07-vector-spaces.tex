...
Thus, the inverse is unique.
    ...
    \item Consider $0 \cdot v = (0 + 0) \cdot v = 0 \cdot v + 0 \cdot v$. 
By adding $-(0 \cdot v)$ to both sides, we yield $0_V = 0 \cdot v$.

    \item Similarly, $\alpha \cdot 0_V = \alpha \cdot (0_V + 0_V) = \alpha \cdot 0_V + \alpha \cdot 0_V$. Adding $-(\alpha \cdot 0_V)$ yields $0_V = \alpha \cdot 0_V$.
