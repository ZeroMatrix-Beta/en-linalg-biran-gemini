...
\begin{enumerate}
    ...
    \[
        \left\langle \binom{x_1}{x_2}, \binom{y_1}{y_2} \right\rangle_A = x_1 y_1 - x_2 y_2
    \]
    But taking $v = \binom{0}{1}$, we get:
    \[
        \left\langle \binom{0}{1}, \binom{0}{1} \right\rangle_A = -1 < 0
    \]
...
\subsection{The geometry on \texorpdfstring{$V$}{V} and the choice of inner product}
...
\begin{remark}
    The relationship between orthogonality and the norm is captured by the Pythagorean Theorem (\cref{thm:pythagoras}), which states that for orthogonal vectors $u$ and $v$, the squared norm of their sum is the sum of their squared norms: $\|u+v\|^2 = \|u\|^2 + \|v\|^2$.
\end{remark}
