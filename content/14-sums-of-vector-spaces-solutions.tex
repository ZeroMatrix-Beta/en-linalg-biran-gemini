...
\exinfo{Official Solution (Problem Sheet 8, Exercise 2). Demonstrates failure of subspace distributivity and provides counterexamples in $\mathbb{R}^2$.}
...
\exinfo{Official Solution (Problem Sheet 8, Exercise 3). Computes lower bound for subspace intersection dimension via Grassmann's formula.}
...
\exinfo{Official Solution (Problem Sheet 8, Exercise 4). Analyzes the sum and intersection of the trace/sum hyperplane and diagonal line depending on field characteristic.}
...
\exinfo{Official Solution (Problem Sheet 8, Exercise 5). Constructs a 3-subspace counterexample showing pairwise trivial intersection does not imply a direct sum.}
...
\exinfo{Hybrid Solution (Gemini 3.7 Flash / Official Problem Sheet 8, Exercise 6). Constructs explicit linear complements for upper triangular and symmetric matrices, treating general characteristic and skew-symmetric projections.}
\begin{enumerate}[label=\textbf{(\alph*)}]
