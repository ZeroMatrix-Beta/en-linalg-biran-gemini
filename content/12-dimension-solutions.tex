...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    \item \textbf{Matrices over $\mathbb{F}_2$ with vanishing column sum.} Let $W \subseteq \M_{n \times n}(\mathbb{F}_2)$ denote this subspace. A matrix $A = (a_{ij}) \in \M_{n \times n}(\mathbb{F}_2)$ belongs to $W$ if and only if for each row index $1 \le i \le n$, the sum of the entries across that row vanishes in $\mathbb{F}_2$:
    \[
...
\end{enumerate}
\exinfo{Official Solution (Problem Sheet 8, Exercise 2). Determines bases and dimensions of upper triangular, diagonal, symmetric, and row-sum zero matrix spaces.}
\end{exercisesolution}

% Official Solution (Problem Sheet 8, Exercise 4)
...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    \[
        ...
        \end{pmatrix}.
    \]
    Subtracting multiples of the first row from the lower rows via $E_2 - 2E_1 \to E_2$, $E_3 - E_1 \to E_3$, and $E_4 - 2E_1 \to E_4$ yields
    \[
        \begin{pmatrix}
            1 & 0 & 1 & 0 \\
            0 & 0 & 2 & 2 \\
        ...
        \end{pmatrix}.
    \]
    Swapping $E_2 \leftrightarrow E_4$ produces
    \[
        \begin{pmatrix}
            1 & 0 & 1 & 0 \\
            0 & 1 & 1 & 1 \\
        ...
        \end{pmatrix}.
    \]
    Adding the second row to the third row ($E_3 + E_2 \to E_3$) gives
    \[
        \begin{pmatrix}
            1 & 0 & 1 & 0 \\
            0 & 1 & 1 & 1 \\
        ...
        \end{pmatrix},
    \]
    and subtracting the third row from the fourth row ($E_4 - E_3 \to E_4$) results in the row echelon form
    \[
        \begin{pmatrix}
            1 & 0 & 1 & 0 \\
            0 & 1 & 1 & 1 \\
    ...
    \]
\end{enumerate}
\exinfo{Official Solution (Problem Sheet 8, Exercise 4). Computes basis selection, dimension, and defining homogeneous Cartesian equations for a subspace in $\mathbb{R}^4$.}
\end{exercisesolution}
...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    \[
        \begin{pmatrix}
            ...
            2 & 0 & 3
        \end{pmatrix}
        \xrightarrow{\substack{E_2 - 3E_1 \to E_2 \\ E_3 - 2E_1 \to E_3}}
        \begin{pmatrix}
            1 & 1 & -1 \\
            0 & -2 & 5 \\
            0 & -2 & 5
        \end{pmatrix}
        \xrightarrow{E_3 - E_2 \to E_3}
        \begin{pmatrix}
            1 & 1 & -1 \\
            0 & -2 & 5 \\
            0 & 0 & 0
...
\end{enumerate}
\exinfo{Solution by Gemini 3.7 Flash (High). Finds bases and dimensions for linear systems, trivial space, and complex vs real planes.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 9)
...
\exinfo{Solution by Gemini 3.7 Flash (High). Computes the dimension of multiples of a fixed linear factor in polynomial spaces.}
\end{exercisesolution}
...
\exinfo{Solution by Gemini 3.7 Flash (High). Demonstrates the 2-dimensional solution space of harmonic oscillator ODE $f'' + f = 0$.}
\end{exercisesolution}

% Solution: Gemini / Official Hybrid (Problem Sheet 8, Exercise 6)
...
\]
\exinfo{Solution by Gemini 3.7 Flash (High). Proves the dimension bound $\dim \Sp(v_1+w, \dots, v_m+w) \ge m-1$ via difference vectors.}
\end{exercisesolution}

% Official Solution (Problem Sheet 8, Exercise 6)
...
\begin{enumerate}[label=\textbf{(\alph*)}]
    ...
    \]
\end{enumerate}
\exinfo{Official Solution (Problem Sheet 8, Exercise 6). Proves stabilization of descending subspace chains in finite dimensions and provides polynomial counterexamples in infinite dimensions.}
\end{exercisesolution}
