...
\exinfo{Official Solution (Problem Sheet 7, Exercise 2). Determines bases and dimensions of upper triangular, diagonal, symmetric, and row-sum zero matrix spaces.}
...
\exinfo{Official Solution (Problem Sheet 7, Exercise 4). Computes basis selection, dimension, and defining homogeneous Cartesian equations for a subspace in $\mathbb{R}^4$.}
\begin{enumerate}[label=\textbf{(\alph*)}]
...
\exinfo{Official Solution (Problem Sheet 7, Exercise 6). Proves stabilization of descending subspace chains in finite dimensions and provides polynomial counterexamples in infinite dimensions.}
\begin{enumerate}[label=\textbf{(\alph*)}]
