...
\begin{itemize}
  \item If $U = \{0\}$ is the trivial subspace, then each equivalence class $[v] = v + \{0\} = \{v\}$ is simply a single \textbf{point}. In this case, no points are ``collapsed'' together, and therefore $\mathbb{R}^2/\{0\} \cong \mathbb{R}^2$.
